...
SOURCES = \
	__init__.py \
	gnss_pos_importer.py gnss_pos_importer_algorithm.py gnss_pos_importer_provider.py

PLUGINNAME = gnss_pos_importer
...
QGISDIR=C:\Users\008308\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
